...
var (
	...
	ErrActiveTurnTargetInactive           = errors.New("active-turn guidance target is no longer active")
	ErrActiveTurnTargetMismatch           = errors.New("active-turn guidance target is no longer active")
	ErrGuidancePreconditionFailed         = errors.New("active-turn guidance failed a pre-dispatch precondition")
	ErrGuidanceExplicitRejection          = errors.New("active-turn guidance was explicitly rejected before application")
	ErrGuidanceSubmitClaimCleanupFailed   = errors.New("active-turn guidance submit claim cleanup could not be confirmed")
