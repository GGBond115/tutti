...
type InstallationCommands interface {
	Install(context.Context, contracts.ConnectorMutation) (contracts.MutationResult, error)
	Uninstall(context.Context, contracts.ConnectorMutation) (contracts.MutationResult, error)
}

type AuthorizationCommands interface {
	BeginAuthorization(context.Context, contracts.ConnectorMutation, []byte) (contracts.AuthorizationResult, error)
	CancelAuthorization(context.Context, contracts.OperationScope, string) error
	DisconnectAuthorization(context.Context, contracts.ConnectorMutation) (contracts.MutationResult, error)
}
...
func (value root) CatalogCommands() CatalogCommands         { return value.service }
func (value root) Installations() InstallationCommands      { return value.service }
func (value root) Authorizations() AuthorizationCommands    { return value.service }
