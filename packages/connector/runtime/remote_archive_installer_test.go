...
func remoteArchiveFixture(t *testing.T) ([]byte, market.Release) {
	...
	release := market.Release{
		...
		Manifest: market.Manifest{SchemaVersion: "1", DisplayName: "AWS CLI", IconURL: "https://cdn.example.test/aws-cli/icon.svg", AuthorizationKind: "none", Compatibility: market.CompatibilityRequirements{MinimumHostVersion: "0.2.27"},
