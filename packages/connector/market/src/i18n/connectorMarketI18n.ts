...
const connectorMarketEn = {
  ...
  actionReauthorize: "Reauthorize",
  actionReinstall: "Reinstall",
  actionRestartRuntime: "Restart",
  actionRestartingRuntime: "Restarting…",
  ...
  composerEmpty: "No connectors available",
  composerMore: "View more connectors",
  composerSelected: "Selected",
  ...
  connectorRuntimeRestartFailed: "Connector restart failed. Try again.",
...
const connectorMarketZhCN = {
  ...
  actionInstall: "安装",
  actionReauthorize: "重新授权",
  actionReinstall: "重新安装",
  actionRestartRuntime: "重新启动",
  actionRestartingRuntime: "正在重新启动…",
  ...
  composerEmpty: "暂无可用连接器",
  composerMore: "查看更多连接器",
  composerSelected: "已选中",
  connectedStatus: "已连接",
  ...
  connectorRuntimeRestartFailed: "连接器重新启动失败，请重试",
