...
- `check-connector-boundaries.mjs` for Connector/AgentGUI dependency direction, Connector renderer recursion, and public Connector export/build/declaration parity
