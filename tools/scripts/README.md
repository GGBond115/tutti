...
- `apps/desktop/scripts/vendor-workspace-app-shell.mjs` for assembling the
  pinned minimal Windows Workspace App Bash runtime used by packaged Desktop;
  CI downloads and verifies the archive from
  `config/tutti.workspace-app-shell.lock.json`, while local packaging may set
