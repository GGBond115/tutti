...
//
// Capability-derived: 0.136.0 is the release that introduced
// skills/extraRoots/set, which runtime preparation requires before starting or
// resuming a thread. Other enrichment calls may degrade gracefully, but Skill
// root configuration is a startup invariant, so older versions are rejected.
//
