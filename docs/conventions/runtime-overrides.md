...
| `TUTTI_AGENT_EXTRA_SKILL_ROOTS_JSON`             | [Agent Runtime Preparation](../architecture/agent-runtime-preparation.md)             | Internal runtimeprep-to-Codex-compatible app-server Adapter handoff for validated Tutti-managed Skill roots; stripped before provider launch and not a supported user override.             |
| `TUTTI_AGENT_STABLE_SYSTEM_SKILLS_ROOT`          | [Agent Runtime Preparation](../architecture/agent-runtime-preparation.md)             | Internal runtimeprep-to-Codex-compatible app-server Adapter handoff for the daemon-owned embedded-Skill cache; stripped before provider launch and not a supported user override.           |
