...
| `CODEX_HOME`                  | [Local State Storage](./local-state-storage.md)                                                            | Injected by tuttid; shared app-server sessions point at durable provider-state `codex-home`, isolated sessions use a run-scoped home.       |
| `TUTTI_AGENT_HOME`            | [Local State Storage](./local-state-storage.md)                                                            | Injected by tuttid; shared app-server sessions point at durable provider-state `tutti-agent-home`, isolated sessions use a run-scoped home. |
