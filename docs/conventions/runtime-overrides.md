...
| `TUTTI_DESKTOP_CONTROL_PLANE_BASE_URL` | [Account Device Presence](../architecture/account-device-presence.md)                              | Overrides the shared desktop control-plane base URL used by account device presence; the legacy Mobile Control Plane override remains a fallback. |
