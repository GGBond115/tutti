...
| `TUTTI_WORKSPACE_APP_SHELL`   | [Workspace App Runtime](./workspace-app-runtime.md)                                                       | Overrides the absolute Windows Bash path used by the Workspace App shell adapter.    |
